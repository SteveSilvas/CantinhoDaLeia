...
public class ConhecaCantinho extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_conheca_cantinho);
        ...
        btnvoltarprog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it = new Intent(ConhecaCantinho.this, MainActivity.class);
                startActivity(it);
            }
        });
